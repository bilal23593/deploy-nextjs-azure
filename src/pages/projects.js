...
const FeaturedProject = ({ type, title, summary, img, link, github }) => {
  return (
    <article
      className="w-full flex items-center justify-between relative rounded-br-2xl rounded-2xl 
    ...
    >
      ...
      <Link
        href={link}
        target="_blank"
        className="w-1/2 cursor-pointer overflow-hidden rounded-lg lg:w-full lg:pl-0 lg-pt-6"
      >
...
const Project = ({ type, title, img, link, github }) => {
  return (
    ...
    border-dark bg-light p-6 relative xs:p-4"
    >
      <Link
        href={link}
        target="_blank"
...
const projects = () => {
  return (
    <>
      <Head>
        <title> Cube Cake Studiios | Projects Page</title>
        <meta
          name="description"
      ...
      <main className="w-full mb-16 flex flex-col items-center justify-center">
        <Layout className="pt-16">
          ...
          />
          <div className="grid grid-cols gap-24 gap-y-32 xl:gap-x-16 lg:gap-x-8 md:gap-y-24 sm:gap-x-0">
...
local currency."
            ...
            {/* <div className="col-span-12">Features Projects</div>
